  ...
  return (
    <div className="space-y-6">
      ...
      <motion.button
        ...
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        className="fixed bottom-[7rem] left-4 z-40 flex items-center gap-2 px-4 py-2.5 rounded-full gradient-primary text-primary-foreground font-semibold text-sm shadow-lg active:scale-95 transition-transform"
      >
